...
export const API_ENDPOINTS = {
  ...
  STUDENT_EXAMS: {
    ...
    PRECHECK: (examId: number) => `/api/student/exams/${examId}/precheck`,
    ...
    EVENTS_BATCH: (attemptId: number) => `/api/student/attempts/${attemptId}/events/batch`,
    SECURITY_SESSION: (attemptId: number) => `/api/student/attempts/${attemptId}/security-session`,
    HEARTBEAT: (attemptId: number) => `/api/student/attempts/${attemptId}/heartbeat`,
  ...
  EXAMS: {
    ...
    PROCTORING_LIVE: (id: number) => `/api/exams/${id}/proctoring/live`,
    SECURITY_SETTINGS: (id: number) => `/api/exams/${id}/security-settings`,
    EVIDENCE: (id: number, attemptId: number) => `/api/exams/${id}/attempts/${attemptId}/evidence`,
    REVIEW: (id: number, attemptId: number) => `/api/exams/${id}/attempts/${attemptId}/review`,
  ...
  QUESTIONS: {
    ...
    BULK_UPDATE: '/api/questions/bulk-update',
    AI_SUGGEST: '/api/questions/ai-suggest',
    VERSIONS: (id: number) => `/api/questions/${id}/versions`,
    VERSION_RESTORE: (id: number, versionId: number) =>
      `/api/questions/${id}/versions/${versionId}/restore`,
    // Unified import pipeline (ImportJob + preview/review/commit).
    IMPORT_JOBS: '/api/questions/import-jobs',
    IMPORT_JOB: (id: number) => `/api/questions/import-jobs/${id}`,
    IMPORT_JOB_PREVIEW: (id: number) => `/api/questions/import-jobs/${id}/preview`,
    IMPORT_JOB_BULK_FIX: (id: number) => `/api/questions/import-jobs/${id}/bulk-fix`,
    IMPORT_JOB_VALIDATE: (id: number) => `/api/questions/import-jobs/${id}/validate`,
    IMPORT_JOB_COMMIT: (id: number) => `/api/questions/import-jobs/${id}/commit`,
    IMPORT_JOB_RETRY: (id: number) => `/api/questions/import-jobs/${id}/retry`,
    IMPORT_PREVIEW_ITEM: (itemId: number) => `/api/questions/import-preview/${itemId}`,
    DUPLICATES: '/api/questions/duplicates',
    DUPLICATES_RESOLVE: '/api/questions/duplicates/resolve',
