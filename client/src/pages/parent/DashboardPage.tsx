    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <Link
          ...
          className="inline-flex min-h-[44px] items-center gap-2 rounded-xl border border-dashed border-slate-300 px-5 py-2.5 text-sm font-semibold text-slate-600 transition-colors hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-700"
        >
    ...
    <div className="mx-auto max-w-lg py-12">
      <Card padding="lg">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 text-xl font-bold text-slate-900">No students linked yet</h2>
          <p className="mt-2 text-sm text-slate-500">
            Link your child's student account to start monitoring their learning progress and exam results.
          </p>
          <Link
            to="/parent/link-student"
            className="mt-6 inline-flex min-h-[44px] items-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
